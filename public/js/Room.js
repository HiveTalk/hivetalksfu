...
function initializeButtonBarToggle() {
    isButtonBarPermanent = localStorageSettings.buttons_bar_permanent || false;
    buttonBarToggle.checked = isButtonBarPermanent;
    if (isButtonBarPermanent) {
        showButtons();
    }
}
...
let isButtonBarPermanent = false;

function showButtons() {
    if (
        isButtonsBarOver ||
        isButtonsVisible ||
        isButtonBarPermanent ||
...
function checkButtonsBar() {
    if (!isButtonsBarOver && !isButtonBarPermanent) {
...
function handleButtonBarToggle() {
    isButtonBarPermanent = buttonBarToggle.checked;
    if (isButtonBarPermanent) {
        showButtons();
    } else {
        checkButtonsBar();
    ...
    rc.saveButtonBarPreference(isButtonBarPermanent);
}

buttonBarToggle.addEventListener('change', handleButtonBarToggle);
